  ...
  group('Entry Page', () {
    group('Show view', () {
      testWidgets('shows the entry fields', (tester) async {
        ...
        expect(find.text(DateFormat.yMMMd().format(DateTime(2020)),
        ), findsOneWidget);
    ...
    group('Edit view', () {
      ...
      testWidgets('creates a new entry', (tester) async {
        ...
        final editor = tester.element(find.byKey(bodyFieldKey)).widget as TextEditor;
        editor.controller.compose(Delta.fromJson([
          {'insert': 'simulating body\n'}
        ]), TextSelection.fromPosition(const TextPosition(offset: 0)), ChangeSource.LOCAL);
